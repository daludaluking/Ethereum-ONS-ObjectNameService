...
contract ONS is Ownable, Authorizable
{
    ...
    * @return boolean flag if ONSrecord is added.
    */
    function addServiceType(bytes32 _serviceTypeKey, bool _abstrct, bytes32 _extends, string _WSDL, 
                            string _homepage, bytes32 _languageCodeKey, string _location, 
                            bytes32 _obsoletes, bytes32 _obsoletedBy) public returns(bool success) 
    {
